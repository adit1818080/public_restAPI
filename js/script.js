const ApiKey = "8d3546f9cd0649f69046abbee08f5ec3";
...
const teamDetail = `${baseUrl}teams/${id}`;
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#ttt" class="secondary-content"><i class="material-icons">info</i></a>
                </li>
                `
            });
            contents.innerHTML = '<ul class="collection">' + team + '</ul>'
        }).catch(err => {
            console.error(err);
        })
}
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#team" class="secondary-content"><i class="material-icons">info</i></a>
                </li>
                `
            });
